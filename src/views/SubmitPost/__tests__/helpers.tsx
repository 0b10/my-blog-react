 ...
 * @param type - the type of validation - e.g. min, max..
 * @param offset - this is added to the exected length - e.g. min(4) + (-1) would return "aaa" === 3
 * @param str - the repeating sequence to use - typically a char
 * @returns A string that has a length equal to the validation schema expected value for that field,
 *  \+/- the offset value
